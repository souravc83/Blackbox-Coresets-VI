...
parser.add_argument(
    ...
    choices=["kmeans", "el2n", "entropy", "least_confidence", "forgetting",
             ...
             "scored_kmeans_least_confidence", "random", "scored_random_el2n", 
             "scored_random_forgetting", "scored_random_entropy", "scored_random_least_confidence",
             "incremental", "weighted_kmeans", "kmeans_gradient", "submodular"
            ],
    type=str,
...
def experiment_driver(
    ...
    for dnm in datasets:
        ...
        print(f"Details about dataset: Total Datapoints: {N}, Dimensions: {D}, num classes: {num_classes}")
